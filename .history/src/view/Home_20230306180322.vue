<template>
    ...
    <div class="p-10 bg-black/[.7]">
        <v-parallax
            src="http://trumpwallpapers.com/wp-content/uploads/Night-Sky-Wallpaper-01-1920x1080-1.jpg" height="300"
        >
            <v-sheet class="mx-auto" elevation="8" theme="dark">
                <v-slide-group
                    v-model="model"
                    class="pa-4"
