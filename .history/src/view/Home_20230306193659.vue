<template>
                    ...
                    <v-row dense>
                        <v-col cols="12">
                            <v-card color="#26A69A" theme="dark">
                                ...
                                <v-card-subtitle
                                    >explore all meals around the world by just
                                    giving the name of meals</v-card-subtitle
                                >
                            ...
                            <v-card color="black" theme="dark">
                                ...
                                >
                                    <div>
                                        ...
                                        <v-card-subtitle
                                            >500+ ingredients for you</v-card-subtitle
                                        >
    ...
    <div class="p-10">
        <v-row justify="space-around" class="px-5">
            <v-col cols="auto">
                <v-sheet elevation="10" class="py-4 px-10" rounded>
                    <v-chip-group
                        mandatory
                        selected-class="text-info"
                        v-model="area"
                    >
                        <v-chip v-for="tag in areaList" :key="tag" :value="tag">
                            {{ tag }}
                        </v-chip>
                    </v-chip-group>
                </v-sheet>
