<template>
    ...
    <div class="w-full flex py-5">
        <div style="width: 960px" class="flex items-center justify-center">
            <iframe
                width="700"
                height="394"
        ...
        <div>
            <v-card max-width="400" class="mx-auto">
                <v-container>
                    <v-row dense>
                        <v-col cols="12">
                            <v-card color="#26A69A" theme="dark">
                                <v-card-title class="text-h5">
                                    Name
                                </v-card-title>

                                <v-card-subtitle
                                    >explore all meals around the world by
                                    Name</v-card-subtitle
                                >

                                <v-card-actions>
                                    <v-btn variant="text"> Try Now </v-btn>
                                </v-card-actions>
                            </v-card>
                        </v-col>

                        <v-col cols="12">
                            <v-card color="#1A237E" theme="dark">
                                <div
                        ...
                        <v-col cols="12">
                            <v-card color="black" theme="dark">
                                ...
                                >
                                    ...
                                    >
                                        <v-img
                                            src="https://images.herzindagi.info/image/2020/Aug/Substitutes-For-Common-Kitchen-Ingredients.jpg"
                                        ></v-img>
                                    </v-avatar>
                                </div>
                            </v-card>
    ...
    <div class="p-10 ">
        <v-row justify="space-around" class="px-5 bg-slate-600 rounded-xl">
            <v-col cols="auto">
                <v-sheet elevation="10" class="py-4 px-10 bg-transparent" rounded>
                    <v-chip-group
                        mandatory
                        selected-class="text-red"
                        v-model="area"
                    >
                        <v-chip v-for="tag in areaList" :key="tag" :value="tag" class="text-white">
                            {{ tag }}
                        </v-chip>
                    </v-chip-group>
                </v-sheet>
