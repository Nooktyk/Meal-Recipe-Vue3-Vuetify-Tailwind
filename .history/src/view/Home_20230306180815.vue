<template>
    ...
    <div>
        <v-parallax
            src="https://images.wallpapersden.com/image/download/artistic-full-moon-in-starry-night-sky_a2VtaG6UmZqaraWkpJRobWllrWdma2U.jpg"
            height="420"
        >
            <div class="p-10">
                <v-sheet class="mx-auto bg-transparent text-white" elevation="8">
                    <v-slide-group
                        v-model="model"
                        class="pa-4"
...
onMounted(async () => {
    ...
    if (true) {
        const { data } = await axiosClient("filter.php?a=Canadian");
        console.log(data);
    }
});
