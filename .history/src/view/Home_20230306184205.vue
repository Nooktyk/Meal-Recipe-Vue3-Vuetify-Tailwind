<template>
                        ...
                        <v-col cols="12">
                            <v-card color="#385F73" theme="dark">
                                ...
                                <v-card-subtitle
                                    ...
                                    whenever and wherever, online and
                            ...
                            <v-card color="#1F7087" theme="dark">
                                ...
                                >
                                    <div>
                                        ...
                                        <v-card-subtitle
                                            >Foster the People</v-card-subtitle
                                        >
                            ...
                            <v-card color="#952175" theme="dark">
                                ...
                                >
                                    <div>
                                        ...
                                        <v-card-subtitle
                                            >Ellie Goulding</v-card-subtitle
                                        >
        ...
        <v-row justify="space-around" class="px-5">
            <v-col cols="auto">
                <v-sheet elevation="10" class="py-4 px-10" rounded>
                    <v-chip-group mandatory selected-class="text-info">
                        <v-chip v-for="tag in areaList" :key="tag">
                            {{ tag.strArea }}
                        </v-chip>
                    </v-chip-group>
                </v-sheet>
    ...
    <div class="w-full px-10 flex">
        <v-card v-for="meal of meals" :key="meal.idMeal"  color="purple" elevation="20" max-width="400" style="width: 500px;">
            <div class="d-flex justify-between">
                <v-card-title class="flex-grow-1 flex-column align-start">
                    <div class="text-h5">{{ meal.strMeal }}</div>
