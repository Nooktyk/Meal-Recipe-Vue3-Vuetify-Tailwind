<template>
    <v-parallax
        src="https://b.kisscc0.com/20180517/pw/kisscc0-desktop-wallpaper-milky-way-night-sky-nature-5afd5ff6ba48e2.562681451526554614763.jpg"
    >
        <v-carousel
            cycle
            height="600"
        ...
        <div class="w-full p-10 flex gap-10">
            ...
            <div>
                <v-btn @click="onClickRandom">Random</v-btn>
            </div>
        </div>
    </v-parallax>
    <Foorbar />
...
import Foorbar from "../components/Foorbar.vue";
