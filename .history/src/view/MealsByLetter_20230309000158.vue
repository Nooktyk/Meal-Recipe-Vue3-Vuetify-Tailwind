<template>
    <div class="flex items-center">
        <v-icon icon="mdi-bus-articulated-front"></v-icon>
    ...
    <div class="flex flex-col gap-5">
        <div class="p-2 bg-blue-900 rounded-lg text-xl">
            <v-tabs v-model="tab" bg-color="deep-purple-darken-4" center-active>
                <v-tab v-for="letter of letters" :key="letter" :value="letter" class="text-xl">
                    {{ letter }}
                </v-tab>
            </v-tabs>
        </div>
